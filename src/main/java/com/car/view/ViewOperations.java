...
import com.car.controller.implementation.AbstractControllerImp;
...
public class ViewOperations<E> {
    ...
    private final AbstractControllerImp<E> controller;
    private final Class<E> eClass;
    private final Scanner input = new Scanner(System.in);

    public ViewOperations(AbstractControllerImp<E> controller, Class<E> eClass) {
    ...
    public void update() {
        ...
        List<Field> fields = Arrays.stream(eClass.getDeclaredFields()).filter(field -> {
            return (field.isAnnotationPresent(Column.class) || field.isAnnotationPresent(JoinColumn.class)) && !field.isAnnotationPresent(Id.class);
